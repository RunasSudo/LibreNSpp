...
function dispatchEditor() {
    ...
    $("<tr></tr>").append($('<td class="leftside">Newspaper Dispatch:</td>')).append($("<td></td>").append($('<input id="settingNewspaperDispatch">').keyup(updateDispatchJSON))).insertBefore($("textarea[name=\"message\"]").parent().parent());
...
function updateDispatchJSON() {
    ...
    json += '"newspaper":"' + $("#settingNewspaperDispatch").val() + '"';
    json += "}";
